#!/bin/bash
# Job name:
#SBATCH --job-name=dask_features_tada_yeast_TFs
#
# Account:
...
in_file="/global/scratch/projects/fc_mvslab/OpenProjects/Sanjana/consensus_AD_predictor/data/yeast_TFs.fasta"
out_dir="/global/scratch/projects/fc_mvslab/OpenProjects/Sanjana/consensus_AD_predictor/output/dask_scripts_test"
script="/global/scratch/projects/fc_mvslab/OpenProjects/Sanjana/consensus_AD_predictor/scripts/run_tada_dask_features.py"
