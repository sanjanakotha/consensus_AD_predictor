#!/bin/bash
#SBATCH --job-name=calc_seq_props_CL
...
python /global/scratch/projects/fc_mvslab/OpenProjects/Sanjana/consensus_AD_predictor/scripts/calculate_properties.py \
    --input /global/scratch/projects/fc_mvslab/OpenProjects/Sanjana/consensus_AD_predictor/output/cl_seqs.fasta \
    --output /global/scratch/projects/fc_mvslab/OpenProjects/Sanjana/consensus_AD_predictor/output/cl_seqs_seq_props.csv