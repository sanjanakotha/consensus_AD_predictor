#!/bin/bash
# Job name:
#SBATCH --job-name=dask_adpred_77
#
# Account:
...
in_file="/global/scratch/projects/fc_mvslab/OpenProjects/Sanjana/consensus_AD_predictor/data/interpro_uniprot_evid_1_2_split/pt_77.fasta"
